...
## Public Header — `app/components/Header.tsx`
```tsx
"use client";
        ...
        <div className="px-16">
          <div className="flex items-center justify-between gap-4">
            <div className="px-header-logo">
              <Link href="/" className="pointer-events-auto relative z-[90]">
                <Image
        ...
        <div className="px-offcanvas-2-wrapper offcanvas-menu">
          <div className="px-offcanvas-2-grid">
            <div className="px-offcanvas-2-left">
              <nav className="tp-offcanvas-menu" aria-label="Primary">
                <ul>
                  {NAV.map((item) => {
            ...
            <div className="px-offcanvas-2-right">
              <div className="px-offcanvas-2-info text-white">
                <p className="px-offcanvas-2-info-label">Studio</p>
                <h3 className="px-offcanvas-2-info-title">
                  Let&apos;s talk about
                  <br />
                  your next project.
                </h3>
                <a
                  href="mailto:hello@pixora.studio"
                  className="px-offcanvas-2-info-link"
                >
                  hello@pixora.studio
                </a>
                <a href="tel:+12155550198" className="px-offcanvas-2-info-link">
                  +1 (215) 555-0198
                </a>
                <p className="px-offcanvas-2-info-meta">
                  Philadelphia, PA
                  <br />
                  Mon–Fri · 09:00–18:00
                </p>
...
## Public Footer — `app/components/Footer.tsx`
```tsx
"use client";
          ...
          <div className="flex flex-wrap items-start gap-y-10">
            <div className="w-full pb-10 lg:w-1/3 xl:w-1/3">
              <div
                ...
                data-delay=".3"
              >
                <h4 className="m-0 font-thunder text-[clamp(40px,5vw,80px)] font-bold uppercase leading-none text-white">
                  Helping
                  <br />
            ...
            <div className="w-full pb-10 md:w-1/2 lg:w-1/3 xl:w-5/12">
              <div
                ...
                data-delay=".5"
              >
                <h4 className="mb-6 m-0 text-lg font-semibold tracking-[0.02em] text-white">Quick links</h4>
                <div className="[&_ul]:m-0 [&_ul]:flex [&_ul]:list-none [&_ul]:flex-wrap [&_ul]:gap-2.5 [&_ul]:p-0 [&_li]:list-none [&_a]:inline-block [&_a]:rounded-[20px] [&_a]:bg-white/10 [&_a]:px-5 [&_a]:py-[13px] [&_a]:text-sm [&_a]:font-medium [&_a]:uppercase [&_a]:leading-none [&_a]:text-white [&_a]:transition-[background,color] [&_a]:duration-300 hover:[&_a]:bg-px-red">
                  <ul>
                    {QUICK_LINKS.map((l) => (
                      <li key={l.label} style={{ marginRight: 5 }}>
            ...
            <div className="w-full pb-10 md:w-1/2 lg:w-1/3 xl:w-1/4">
              <div
                ...
                data-delay=".7"
              >
                <h4 className="mb-5 m-0 text-lg font-semibold tracking-[0.02em] text-white">Contact</h4>
                <div className="flex flex-col gap-2 [&_a]:text-base [&_a]:text-white [&_a]:transition-colors [&_a]:duration-300 hover:[&_a]:text-px-red">
                  <a href="mailto:pixora@studio.com">pixora@studio.com</a>
...
## Note for Admin
Admin will live under a new route group e.g. `app/(admin)/admin/...` with its **own layout** (sidebar + top bar). Do not wrap admin in SiteChrome/Header/Footer.
